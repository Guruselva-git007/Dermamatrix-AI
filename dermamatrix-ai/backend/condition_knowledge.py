...
SOURCE_CATALOG = {
    ...
    "onychogryphosis": {
        "title": "DermNet: Onychogryphosis",
        "url": "https://dermnetnz.org/topics/onychogryphosis",
        "evidence_type": "Dermatologist-reviewed education",
    },
    "nail_changes": {
        "title": "American Academy of Dermatology: Nail changes to examine",
...
COMMON_CONDITION_KNOWLEDGE = {
    ...
    "scalp-psoriasis": _education_topic(
        topic_id="scalp-psoriasis", name="Scalp psoriasis pattern", health_area="Hair", aliases=("scaly scalp plaques",),
        description="Scalp psoriasis can cause thick scale and inflammation, but dandruff, eczema, and fungal conditions can look similar.",
        visual_features=("Scaly scalp patches", "Possible redness or flakes around the hairline"),
        symptoms=("Scale", "Itching or burning", "Scalp discomfort"),
        contributors=("Inflammatory skin process", "Personal triggers such as stress or irritation"),
        differentials=("Seborrheic dermatitis", "Tinea capitis", "Contact dermatitis"),
        care_options=("Wash scalp gently without forcibly removing scale", "Avoid scratching or irritating products", "Discuss persistent or painful scale with a dermatologist"),
        medication_topics=({"name": "Clinician-directed scalp anti-inflammatory treatment", "access": "Prescription", "note": "Choice depends on scalp examination, extent, age, and other health factors."},),
        routine=("Wash at a frequency your scalp tolerates", "Condition hair lengths without vigorous scalp rubbing", "Track scale, itching, and any hair loss"),
        lifestyle=("Avoid picking thick scale", "Record changes in products, stress, and skin symptoms elsewhere"),
        red_flags=("Scalp pain, pus, or rapid spread", "Patchy hair loss", "New joint pain or stiffness"),
        specialty="Dermatologist", source_keys=("psoriasis_guideline",), timeline="Reassess persistent scale or hair loss with a dermatologist; treatment response varies.",
    ),
    ...
    "onychogryphosis": _education_topic(
        topic_id="onychogryphosis", name="Thick curved nail pattern", health_area="Nails", aliases=("onychogryphosis", "ram's horn nail"),
        description="Onychogryphosis describes a thick, hard, curved nail. Footwear pressure, trauma, circulation, psoriasis, and fungal infection can overlap; a photo does not establish the cause.",
        visual_features=("Marked nail thickening", "Curved or elongated nail plate", "Yellow-brown discoloration in some cases"),
        symptoms=("Pressure discomfort in footwear", "Difficulty trimming", "Sometimes no pain"),
        contributors=("Repeated nail-bed trauma", "Poorly fitting footwear", "Age-related change or underlying nail disease"),
        differentials=("Fungal nail infection", "Nail psoriasis", "Traumatic nail dystrophy"),
        care_options=("Choose footwear that does not press on the nail", "Keep the nail clean and dry", "Seek professional trimming if the nail is too thick to cut safely"),
        medication_topics=({"name": "Clinician nail reduction or debridement", "access": "Professional procedure", "note": "A clinician can assess the cause and reduce a very thick nail safely; antifungal treatment only fits a confirmed infection."},),
        routine=("Dry feet and the nail after washing", "Avoid digging under the nail or cutting into skin", "Check footwear pressure and watch for pain or redness"),
        lifestyle=("Avoid repeated shoe pressure and trauma", "Seek nail care support if self-trimming is difficult"),
        red_flags=("Pain, bleeding, infection, or a rapidly changing nail", "Diabetes or poor circulation with a damaged nail"),
        specialty="Dermatologist or podiatrist", source_keys=("onychogryphosis",), timeline="Nail growth is slow; review persistent thickening, pain, or trouble trimming.",
    ),
    "melanonychia": _education_topic(
        topic_id="melanonychia", name="Dark nail streak pattern", health_area="Nails", aliases=("melanonychia", "dark nail line"),
        description="A dark nail band can have several causes, including pigment production, trauma, and occasionally a serious nail-unit lesion. A new or changing streak needs direct assessment.",
        visual_features=("Brown or black lengthwise nail band", "Possible change in width or color"),
        symptoms=("Often no discomfort", "Possible concern about a changing streak"),
        contributors=("Benign pigment variation", "Trauma or medicines", "Nail-unit disease requiring examination"),
        differentials=("Benign melanonychia", "Subungual bleeding", "Nail-unit melanoma"),
        care_options=("Photograph the nail in consistent light", "Avoid covering a changing band with polish before examination", "Arrange dermatologist review for a new or changing streak"),
        medication_topics=(), routine=("Keep the nail clean and trimmed safely", "Track width, color, and surrounding skin changes", "Do not self-treat with antifungal or bleaching products"),
        lifestyle=("Avoid nail trauma", "Record when the streak first appeared"),
        red_flags=("New or widening dark streak", "Pigment spreading to surrounding skin", "Bleeding, pain, or nail destruction"),
        specialty="Dermatologist", source_keys=("nail_changes",), timeline="A new or changing dark streak merits timely dermatologist assessment.",
    ),
