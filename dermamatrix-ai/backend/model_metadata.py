...
HEALTH_AREA_CAPABILITY_CONFIG = {
    ...
    "Hair": {
        ...
        "user_message": "Image-quality screening is available. No trained hair/scalp condition classifier is configured in this deployment.",
    },
    "Nails": {
        "model_id": "nail-model-adapter",
        "input_mode": "image",
        ...
        "user_message": "Image-quality screening is available. No trained nail condition classifier is configured in this deployment.",
    },
    "Sweat": {
        "model_id": "sweat-questionnaire-v1",
