...
EXCLUDED_DATASETS = {
    ...
    "hair_and_nail": {
        "reason": "No public, task-matched, governed dataset with sufficient labels and an evaluated model has been selected in this repository. Hair and nail image inference therefore remains unavailable rather than fabricated.",
    },
}


DATASET_REGISTRY = {"scin_v1": SCIN_V1, "excluded": EXCLUDED_DATASETS}
