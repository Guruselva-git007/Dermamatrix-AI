...
def validate_result_content(result: dict) -> dict:
    ...
    checks = {
        ...
        "causes": len(_items(consumer.get("cause_sections"))) >= 2,
        "treatment": len(_items(consumer.get("treatment_sections"))) >= 2,
        "category_care": len(_items(consumer.get("care_sections"))) >= 2,
        "routine": len(_items(consumer.get("routine_sections"))) >= 2,
        "diet_nutrition": len(_items(consumer.get("nutrition_sections"))) >= 2,
        ...
        "products": len(products) >= 2 and all(product.get("name") and product.get("commerce", {}).get("primary", {}).get("url") for product in products),
